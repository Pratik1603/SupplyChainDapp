...
const Form=({setCreateShipmentModel,createShipment,createShipmentModel})=>{
            ...
            <div className="flex item-center min-h-screen px-4 py-8">
                <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
                    ...
                    <form onSubmit={(e)=>e.preventDefault()}>
                        ...
                        <button onClick={createItem} className="block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500 activate:bg-indigo-700 rounded-lg ring-offset-2 ring-indigo-600 focus-ring-2">
                                Create Shipment
                        </button>
